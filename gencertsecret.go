...
func main() {
	...
	if err := ioutil.WriteFile(serverCertPath, newSecret.Data[corev1.TLSCertKey], 0644); err != nil {
		fmt.Println(err.Error())
		os.Exit(2)
	}
	if err := ioutil.WriteFile(serverKeyPath, newSecret.Data[corev1.TLSPrivateKeyKey], 0644); err != nil {
		fmt.Println(err.Error())
		os.Exit(2)
	}
